...
namespace appNamespace {
	...
	void AppDevice::createSurface() { window.createWindowSurface(_instance, &surface_); }
	...
	void AppDevice::createTextureSampler() {
		...
		if (vkCreateSampler(this->device(), &samplerInfo, nullptr, &this->textureSampler_) != VK_SUCCESS) {
